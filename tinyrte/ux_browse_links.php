...
class TBE_browser_recordListIR extends localRecordList {
	...
	function listURL($altId='',$table=-1,$exclList='')	{
		...
		return $this->script.
            ...
            '&mode='.$this->i6lGParams['mode'].'&act='.$this->i6lGParams['act'].'&RTEtsConfigParams='.$this->i6lGParams['RTEtsConfigParams'].'&expandPage='.$this->i6lGParams['expandPage'].'&curUrlInfo='.$this->i6lGParams['curUrlInfo'].'&SEL='.$this->i6lGParams['SEL'];
			;
	}
	...
	function fwd_rwd_HTML($type,$pointer,$table='')	{
		...
		switch($type)	{
			case 'fwd':
				$href = $this->script.'?id='.$this->id.'&pointer='.($this->eCounter-$this->iLimit).$tParam.'&search_field='.t3lib_div::_GP('search_field').'&mode='.$this->i6lGParams['mode'].'&editorNo='.$this->i6lGParams['editorNo'].'&act='.$this->i6lGParams['act'].'&RTEtsConfigParams='.$this->i6lGParams['RTEtsConfigParams'].'&expandPage='.$this->i6lGParams['expandPage'].'&curUrlInfo='.$this->i6lGParams['curUrlInfo'].'&SEL='.$this->i6lGParams['SEL'];
			...
			break;
			case 'rwd':
				$href = $this->script.'?id='.$this->id.'&pointer='.$this->eCounter.$tParam.'&search_field='.t3lib_div::_GP('search_field').'&mode='.$this->i6lGParams['mode'].'&editorNo='.$this->i6lGParams['editorNo'].'&act='.$this->i6lGParams['act'].'&RTEtsConfigParams='.$this->i6lGParams['RTEtsConfigParams'].'&expandPage='.$this->i6lGParams['expandPage'].'&curUrlInfo='.$this->i6lGParams['curUrlInfo'].'&SEL='.$this->i6lGParams['SEL'];
...
class ux_SC_browse_links extends SC_browse_links {
	...
	function main_rte($wiz=0)	{
		...
		switch($this->act)	{
				...
				$content.= '<div class="panel_wrapper" style="height: 250px;">
				<!--
				Wrapper table for page tree / record list:
				-->
				<table border="0" cellpadding="0" cellspacing="0" height="125">
				<tr>
					<td valign="top" style="width: 250px;"><fieldset><legend>Page tree</legend><DIV STYLE="width: 240px; height: 125px; overflow-x:hidden ; overflow-y:scroll;"><table><tr><td>'.$tree.'</td></tr></table></div></fieldset></td>
					<td valign="top" style="width: 5px;"><img src="clear.gif" width="5"></td>
					<td valign="top" style="width: 188px;"><fieldset><legend>Content elements</legend><DIV STYLE="width: 178px; height: 125px; overflow-x:hidden ; overflow-y:scroll;"><table><tr><td>'.$cElements.'</td></tr></table></div></fieldset></td></tr></table>';

					// Add some space    
				$content.='<img src="clear.gif" height="8" width="100%"><fieldset>';
			...
			case 'file':
				...
				<tr>
					<td valign="top" style="width: 250px;"><fieldset><legend>Page tree</legend><DIV STYLE="width: 240px; height: 125px; overflow-x:hidden ; overflow-y:scroll;"><table><tr><td>'.$tree.'</td></tr></table></div></fieldset></td>
					<td valign="top" style="width: 5px;"><img src="clear.gif" width="5"></td>
					<td valign="top" style="width: 188px;"><fieldset><legend>Content elements</legend><DIV STYLE="width: 178px; height: 125px; overflow-x:hidden ; overflow-y:scroll;"><table><tr><td>'.$files.'</td></tr></table></div></fieldset></td></tr></table>';
