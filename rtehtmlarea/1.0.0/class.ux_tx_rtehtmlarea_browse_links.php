...
class ux_tx_rtehtmlarea_browse_links extends tx_rtehtmlarea_browse_links {
	...
	function main_rte($wiz=0)	{
		...
		if (count($lrKeys)>0) { 
			...
			$menuDef['linkRecord']['label'] = $browseTabLabel;
               	} else { 
		...
		$menuDef['ux_linkRecord']['addParams'] = 'onclick="jumpToUrl(\'?act=linkRecord&amp;mode=rte'.$expandPage.'\');return false;"';
